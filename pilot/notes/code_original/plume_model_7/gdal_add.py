...
# $Id: gdal_add.py
#
# Project:  NCEAS Ecosystem Based Management
...
def raster_add( s_fh, s_xoff, s_yoff, s_xsize, s_ysize, s_band_n,
    ...
    nodata_test = numpy.equal(data_src,s_band.GetNoDataValue())
    data_src_fill = numpy.choose( nodata_test, (data_src, 0) )
   
    to_write = numpy.add(data_src_fill,data_dst)
...
# =============================================================================
def Usage():
    print 'Usage: gdal_add.py [-o out_filename] [-of out_format] [-co NAME=VALUE]*'
